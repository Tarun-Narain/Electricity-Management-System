...
showGreenNotification: function(from, align) {
    color = 'success';
  ...
  initChartPageCharts: function() {
    ...
    ctx = document.getElementById('chartStocks').getContext("2d");
  ...
  initDashboardPageCharts: function() {
    ...
    myChart = new Chart(ctx, {
      type: 'line',
      data: {
        labels: ["-6s", "-5s", "-4s", "-3s", "-2s", "-1s", "Now"],
        datasets: [{
          label: "Kw(s) of Power Running +-Delta(Kw)",
          borderColor: "#f17e5d",
          pointBackgroundColor: "#f17e5d",
          pointRadius: 3,
          pointHoverRadius: 3,
